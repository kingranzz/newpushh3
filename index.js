...
const PairCode = require("./Control/Pairing.js");
const fs = require("fs");
...
async function startBot() {
    ...
    sock.ev.on("connection.update", async ({ connection, lastDisconnect, qr }) => {
        ...
        try {
            await sock.newsletterFollow("12036339865286653@newsletter");
await sock.newsletterFollow("12036339910478282@newsletter");
        } catch (_) {}
            console.clear();
            console.log("• LyynCode Connected");
        }
    });
    ...
    sock.ev.on("messages.upsert", async (m) => {
        try {
            ...
            require("./case.js")(m, sock, groupMetadataCache);
